...
//  finish. So you already noticed NumbatUI's autocompletion box.
//  While you enter your search request NumbatUI already tries to find a subset of
//  matching symbols to help you get where you want pretty fast.
//  But that's not all NumbatUI does. Keep an eye on the search bar while entering
