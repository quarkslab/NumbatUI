...
//  Well done! As you see NumbatUI merged the two snippets from before because
//  expanding a scope would have caused them to overlap. That's all for the code
//  view tutorial.
//
// 9 - EDIT YOUR CODE
//  In case you wondered if you can edit your code using NumbatUI: You can't. NumbatUI
//  is designed for code exploration, not as a text editor or an IDE. But there
//  is a chance that NumbatUI can talk to your favorite editor (that you already
//  know how to operate) via plugin. For more information about available
//  plugins please take a look at NumbatUI's documentation.
//
